...
dependencies {
    testImplementation(project(":arcade-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../arcade-java-core/src/main/resources/META-INF/proguard/arcade-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("dev.arcade.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../arcade-java-core/src/main/resources/META-INF/proguard/arcade-java-core.pro",
