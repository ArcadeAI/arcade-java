...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class dev.arcade.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class dev.arcade.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class dev.arcade.** {
    <init>(...);
