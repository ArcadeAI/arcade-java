...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(healthCheckParams: HealthCheckParams) = apply {
            additionalHeaders = healthCheckParams.additionalHeaders.toBuilder()
            additionalQueryParams = healthCheckParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): HealthCheckParams =
            HealthCheckParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is HealthCheckParams && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "HealthCheckParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
