...
class ToolScheduledListPageAsync
private constructor(
    private val scheduledService: ScheduledServiceAsync,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ToolScheduledListPageAsync && scheduledService == other.scheduledService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(scheduledService, params, response) /* spotless:on */

    override fun toString() =
        "ToolScheduledListPageAsync{scheduledService=$scheduledService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<ToolScheduledListPageAsync>> {
        return getNextPageParams()
            .map { scheduledService.list(it).thenApply { Optional.of(it) } }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(
            scheduledService: ScheduledServiceAsync,
            params: ToolScheduledListParams,
            response: Response,
        ) = ToolScheduledListPageAsync(scheduledService, params, response)
    }
    ...
    class AutoPager(private val firstPage: ToolScheduledListPageAsync) {

        fun forEach(action: Predicate<ToolExecution>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<ToolScheduledListPageAsync>>.forEach(
                action: (ToolExecution) -> Boolean,
                executor: Executor,
        ...
        fun toList(executor: Executor): CompletableFuture<List<ToolExecution>> {
            val values = mutableListOf<ToolExecution>()
