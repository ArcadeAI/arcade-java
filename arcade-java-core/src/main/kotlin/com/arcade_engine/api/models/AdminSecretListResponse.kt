...
@NoAutoDetect
class AdminSecretListResponse
@JsonCreator
private constructor(
    @JsonProperty("items")
    @ExcludeMissing
    private val items: JsonField<List<SecretResponse>> = JsonMissing.of(),
    ...
    fun items(): Optional<List<SecretResponse>> = Optional.ofNullable(items.getNullable("items"))
    ...
    fun validate(): AdminSecretListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [AdminSecretListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(adminSecretListResponse: AdminSecretListResponse) = apply {
            items = adminSecretListResponse.items.map { it.toMutableList() }
            limit = adminSecretListResponse.limit
            offset = adminSecretListResponse.offset
            pageCount = adminSecretListResponse.pageCount
            totalCount = adminSecretListResponse.totalCount
            additionalProperties = adminSecretListResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): AdminSecretListResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AdminSecretListResponse && items == other.items && limit == other.limit && offset == other.offset && pageCount == other.pageCount && totalCount == other.totalCount && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "AdminSecretListResponse{items=$items, limit=$limit, offset=$offset, pageCount=$pageCount, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
