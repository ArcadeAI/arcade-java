...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ToolFormattedListParams && format == other.format && limit == other.limit && offset == other.offset && toolkit == other.toolkit && userId == other.userId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(format, limit, offset, toolkit, userId, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ToolFormattedListParams{format=$format, limit=$limit, offset=$offset, toolkit=$toolkit, userId=$userId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
