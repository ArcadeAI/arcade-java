...
private constructor(
    ...
    @JvmSynthetic internal fun _body(): ChatRequest = chatRequest
    ...
    class Builder internal constructor() {
        ...
        internal fun from(chatCompletionCreateParams: ChatCompletionCreateParams) = apply {
            chatRequest = chatCompletionCreateParams.chatRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ChatCompletionCreateParams && chatRequest == other.chatRequest && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(chatRequest, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ChatCompletionCreateParams{chatRequest=$chatRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
