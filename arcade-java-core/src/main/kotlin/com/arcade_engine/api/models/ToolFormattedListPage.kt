 ...
 */
class ToolFormattedListPage
private constructor(
    private val formattedService: FormattedService,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ToolFormattedListPage && formattedService == other.formattedService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(formattedService, params, response) /* spotless:on */

    override fun toString() =
        "ToolFormattedListPage{formattedService=$formattedService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<ToolFormattedListPage> {
        return getNextPageParams().map { formattedService.list(it) }
    }
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = ToolFormattedListPage(formattedService, params, response)
    }
    ...
    class AutoPager(private val firstPage: ToolFormattedListPage) :
        Iterable<ToolFormattedListResponse> {

        override fun iterator(): Iterator<ToolFormattedListResponse> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<ToolFormattedListResponse> {
