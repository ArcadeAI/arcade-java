...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AuthStatusParams].
         *
    ...
    class Builder internal constructor() {
        ...
        fun wait(wait: Optional<Long>) = wait(wait.getOrNull())
        ...
        /**
         * Returns an immutable instance of [AuthStatusParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthStatusParams &&
            id == other.id &&
            wait == other.wait &&
    ...
    override fun hashCode(): Int = Objects.hash(id, wait, additionalHeaders, additionalQueryParams)
