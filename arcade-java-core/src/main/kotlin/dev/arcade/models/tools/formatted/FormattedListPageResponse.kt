...
class FormattedListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val items: JsonField<List<FormattedListResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<FormattedListResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): Optional<List<FormattedListResponse>> = items.getOptional("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<FormattedListResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FormattedListPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FormattedListPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<FormattedListResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(formattedListPageResponse: FormattedListPageResponse) = apply {
            items = formattedListPageResponse.items.map { it.toMutableList() }
            limit = formattedListPageResponse.limit
            offset = formattedListPageResponse.offset
            pageCount = formattedListPageResponse.pageCount
            totalCount = formattedListPageResponse.totalCount
            additionalProperties = formattedListPageResponse.additionalProperties.toMutableMap()
        }

        fun items(items: List<FormattedListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<FormattedListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun items(items: JsonField<List<FormattedListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [FormattedListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: FormattedListResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [FormattedListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FormattedListPageResponse =
     ...
     *   expected type.
     */
    fun validate(): FormattedListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FormattedListPageResponse &&
            items == other.items &&
            limit == other.limit &&
            offset == other.offset &&
    ...
    override fun toString() =
        "FormattedListPageResponse{items=$items, limit=$limit, offset=$offset, pageCount=$pageCount, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
