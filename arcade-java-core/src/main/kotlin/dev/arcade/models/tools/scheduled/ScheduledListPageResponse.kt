...
class ScheduledListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val items: JsonField<List<ToolExecution>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<ToolExecution>> = JsonMissing.of(),
     ...
     */
    fun items(): Optional<List<ToolExecution>> = items.getOptional("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<ToolExecution>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ScheduledListPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ScheduledListPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<ToolExecution>>? = null
        ...
        @JvmSynthetic
        internal fun from(scheduledListPageResponse: ScheduledListPageResponse) = apply {
            items = scheduledListPageResponse.items.map { it.toMutableList() }
            limit = scheduledListPageResponse.limit
            offset = scheduledListPageResponse.offset
            pageCount = scheduledListPageResponse.pageCount
            totalCount = scheduledListPageResponse.totalCount
            additionalProperties = scheduledListPageResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<ToolExecution>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<ToolExecution>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [ToolExecution] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: ToolExecution) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [ScheduledListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ScheduledListPageResponse =
    ...
    fun validate(): ScheduledListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScheduledListPageResponse &&
            items == other.items &&
            limit == other.limit &&
            offset == other.offset &&
    ...
    override fun toString() =
        "ScheduledListPageResponse{items=$items, limit=$limit, offset=$offset, pageCount=$pageCount, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
