...
class ToolListPage
private constructor(
    private val toolsService: ToolService,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ToolListPage && toolsService == other.toolsService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(toolsService, params, response) /* spotless:on */

    override fun toString() =
        "ToolListPage{toolsService=$toolsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<ToolListPage> {
        return getNextPageParams().map { toolsService.list(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(toolsService: ToolService, params: ToolListParams, response: Response) =
            ToolListPage(toolsService, params, response)
    }
    ...
    class AutoPager(private val firstPage: ToolListPage) : Iterable<ToolDefinition> {
