...
class UserConnectionListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val items: JsonField<List<UserConnectionResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<UserConnectionResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): Optional<List<UserConnectionResponse>> = items.getOptional("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<UserConnectionResponse>> = items
    ...
    /** A builder for [UserConnectionListPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<UserConnectionResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(userConnectionListPageResponse: UserConnectionListPageResponse) = apply {
            items = userConnectionListPageResponse.items.map { it.toMutableList() }
            limit = userConnectionListPageResponse.limit
            offset = userConnectionListPageResponse.offset
            pageCount = userConnectionListPageResponse.pageCount
            totalCount = userConnectionListPageResponse.totalCount
            additionalProperties =
                userConnectionListPageResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<UserConnectionResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun items(items: JsonField<List<UserConnectionResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [UserConnectionResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: UserConnectionResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [UserConnectionListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UserConnectionListPageResponse =
            UserConnectionListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): UserConnectionListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserConnectionListPageResponse &&
            items == other.items &&
            limit == other.limit &&
            offset == other.offset &&
    ...
    override fun toString() =
        "UserConnectionListPageResponse{items=$items, limit=$limit, offset=$offset, pageCount=$pageCount, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
