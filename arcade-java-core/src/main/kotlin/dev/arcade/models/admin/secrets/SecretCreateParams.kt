...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(secretCreateParams: SecretCreateParams) = apply {
            secretKey = secretCreateParams.secretKey
            body = secretCreateParams.body.toBuilder()
        ...
        /** Alias for calling [Builder.secretKey] with `secretKey.orElse(null)`. */
        fun secretKey(secretKey: Optional<String>) = secretKey(secretKey.getOrNull())
    ...
    override fun hashCode(): Int =
        Objects.hash(secretKey, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "SecretCreateParams{secretKey=$secretKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
