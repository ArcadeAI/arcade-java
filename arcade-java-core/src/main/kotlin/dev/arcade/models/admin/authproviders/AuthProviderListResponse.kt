...
private constructor(
    private val items: JsonField<List<AuthProviderResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<AuthProviderResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): Optional<List<AuthProviderResponse>> = items.getOptional("items")
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AuthProviderListResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AuthProviderListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authProviderListResponse: AuthProviderListResponse) = apply {
            items = authProviderListResponse.items.map { it.toMutableList() }
            limit = authProviderListResponse.limit
            offset = authProviderListResponse.offset
            pageCount = authProviderListResponse.pageCount
            totalCount = authProviderListResponse.totalCount
            additionalProperties = authProviderListResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<AuthProviderResponse>`
        ...
        /**
         * Adds a single [AuthProviderResponse] to [items].
         *
        ...
        /**
         * Returns an immutable instance of [AuthProviderListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthProviderListResponse =
    ...
    fun validate(): AuthProviderListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthProviderListResponse &&
            items == other.items &&
            limit == other.limit &&
            offset == other.offset &&
    ...
    override fun toString() =
        "AuthProviderListResponse{items=$items, limit=$limit, offset=$offset, pageCount=$pageCount, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
