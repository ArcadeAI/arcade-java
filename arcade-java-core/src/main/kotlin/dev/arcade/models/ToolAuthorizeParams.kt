...
private constructor(
    ...
    @JvmSynthetic internal fun _body(): AuthorizeToolRequest = authorizeToolRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ToolAuthorizeParams && authorizeToolRequest == other.authorizeToolRequest && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(authorizeToolRequest, additionalHeaders, additionalQueryParams) /* spotless:on */
