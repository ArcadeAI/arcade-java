...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): WorkerToolsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [WorkerToolsParams]. */
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [WorkerToolsParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WorkerToolsParams &&
            id == other.id &&
            limit == other.limit &&
            offset == other.offset &&
    ...
    override fun hashCode(): Int =
        Objects.hash(id, limit, offset, additionalHeaders, additionalQueryParams)
