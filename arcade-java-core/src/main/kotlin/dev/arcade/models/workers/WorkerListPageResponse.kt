...
class WorkerListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val items: JsonField<List<WorkerResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<WorkerResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): Optional<List<WorkerResponse>> = items.getOptional("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<WorkerResponse>> = items
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [WorkerListPageResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WorkerListPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<WorkerResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(workerListPageResponse: WorkerListPageResponse) = apply {
            items = workerListPageResponse.items.map { it.toMutableList() }
            limit = workerListPageResponse.limit
            offset = workerListPageResponse.offset
            pageCount = workerListPageResponse.pageCount
            totalCount = workerListPageResponse.totalCount
            additionalProperties = workerListPageResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<WorkerResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<WorkerResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [WorkerResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: WorkerResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [WorkerListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WorkerListPageResponse =
            WorkerListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): WorkerListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WorkerListPageResponse &&
            items == other.items &&
            limit == other.limit &&
            offset == other.offset &&
    ...
    override fun toString() =
        "WorkerListPageResponse{items=$items, limit=$limit, offset=$offset, pageCount=$pageCount, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
