...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [WorkerUpdateParams].
         *
    ...
    fun _body(): UpdateWorkerRequest = updateWorkerRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WorkerUpdateParams &&
            id == other.id &&
            updateWorkerRequest == other.updateWorkerRequest &&
            additionalHeaders == other.additionalHeaders &&
            additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int =
        Objects.hash(id, updateWorkerRequest, additionalHeaders, additionalQueryParams)
