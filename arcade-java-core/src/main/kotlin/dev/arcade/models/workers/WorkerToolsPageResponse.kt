...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [WorkerToolsPageResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WorkerToolsPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(workerToolsPageResponse: WorkerToolsPageResponse) = apply {
            items = workerToolsPageResponse.items.map { it.toMutableList() }
            limit = workerToolsPageResponse.limit
            offset = workerToolsPageResponse.offset
            pageCount = workerToolsPageResponse.pageCount
            totalCount = workerToolsPageResponse.totalCount
            additionalProperties = workerToolsPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WorkerToolsPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WorkerToolsPageResponse =
            WorkerToolsPageResponse(
     ...
     *   expected type.
     */
    fun validate(): WorkerToolsPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WorkerToolsPageResponse &&
            items == other.items &&
            limit == other.limit &&
            offset == other.offset &&
    ...
    override fun toString() =
        "WorkerToolsPageResponse{items=$items, limit=$limit, offset=$offset, pageCount=$pageCount, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
