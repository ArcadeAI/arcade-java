...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ToolListParams && includeAllVersions == other.includeAllVersions && includeFormat == other.includeFormat && limit == other.limit && offset == other.offset && toolkit == other.toolkit && userId == other.userId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(includeAllVersions, includeFormat, limit, offset, toolkit, userId, additionalHeaders, additionalQueryParams) /* spotless:on */
