...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WorkerToolsPage && workersService == other.workersService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(workersService, params, response) /* spotless:on */

    override fun toString() =
        "WorkerToolsPage{workersService=$workersService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<WorkerToolsPage> {
        return getNextPageParams().map { workersService.tools(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(workersService: WorkerService, params: WorkerToolsParams, response: Response) =
            WorkerToolsPage(workersService, params, response)
    }
    ...
    class AutoPager(private val firstPage: WorkerToolsPage) : Iterable<ToolDefinition> {

        override fun iterator(): Iterator<ToolDefinition> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<ToolDefinition> {
