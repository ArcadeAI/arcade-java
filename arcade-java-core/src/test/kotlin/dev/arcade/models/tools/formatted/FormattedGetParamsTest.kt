...
internal class FormattedGetParamsTest {
    ...
    @Test
    fun pathParams() {
        val params = FormattedGetParams.builder().name("name").build()
    ...
    fun queryParams() {
        ...
        assertThat(queryParams)
            .isEqualTo(
                QueryParams.builder().put("format", "format").put("user_id", "user_id").build()
            )
    }
